...
public class TestUpdate {
	...
	public void testUpdateAll() throws SQLException {
		...
		BalenteSqlQueryResult result = gsi.execute("rifacimm city accunza city_name accuss� 'NAPULI', city_id accuss� 10");
	...
	public void testUpdateWhere() throws SQLException {
		BalenteSqlInterpreter gsi = new BalenteSqlInterpreter(connection);
		BalenteSqlQueryResult result = gsi.execute("rifacimm city accunza city_name accuss� 'NAPULI', city_id accuss� 10 ar� city_id = 1");
